 ...
 *       &lt;attribute name="state" use="required" type="{http://www.deutsche-boerse.com/m7/v6}marketStateUnionType" />
...
@XmlRootElement(name = "MktStateRprt")
public class MktStateRprt {
