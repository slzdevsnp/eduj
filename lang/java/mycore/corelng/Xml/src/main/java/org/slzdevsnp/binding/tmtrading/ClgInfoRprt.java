 ...
 *         &lt;element name="ClgHseList" type="{http://www.deutsche-boerse.com/m7/v6}ClgHseListType"/>
...
@XmlRootElement(name = "ClgInfoRprt")
public class ClgInfoRprt {

    @XmlElement(name = "StandardHeader", required = true)
    protected StandardHeaderType standardHeader;
    @XmlElement(name = "ClgHseList", required = true)
    protected ClgHseListType clgHseList;
    @XmlAnyElement
    ...
    /**
     * Gets the value of the clgHseList property.
     * 
     * @return
     *     possible object is
     *     {@link ClgHseListType }
     *     
     */
    public ClgHseListType getClgHseList() {
        return clgHseList;
    }

    /**
     * Sets the value of the clgHseList property.
     * 
     * @param value
     *     allowed object is
     *     {@link ClgHseListType }
     *     
     */
    public void setClgHseList(ClgHseListType value) {
        this.clgHseList = value;
    }
