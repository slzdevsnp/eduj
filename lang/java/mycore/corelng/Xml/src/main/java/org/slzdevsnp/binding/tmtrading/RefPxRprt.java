 ...
 *         &lt;element name="RefPxList" type="{http://www.deutsche-boerse.com/m7/v6}RefPxListType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "RefPxRprt")
public class RefPxRprt {

    @XmlElement(name = "StandardHeader", required = true)
    protected StandardHeaderType standardHeader;
    @XmlElement(name = "RefPxList")
    protected RefPxListType refPxList;
    @XmlAnyAttribute
    ...
    /**
     * Gets the value of the refPxList property.
     * 
     * @return
     *     possible object is
     *     {@link RefPxListType }
     *     
     */
    public RefPxListType getRefPxList() {
        return refPxList;
    }

    /**
     * Sets the value of the refPxList property.
     * 
     * @param value
     *     allowed object is
     *     {@link RefPxListType }
     *     
     */
    public void setRefPxList(RefPxListType value) {
        this.refPxList = value;
    }
