 ...
 *         &lt;element name="MktAreaList" type="{http://www.deutsche-boerse.com/m7/v6}MktAreaListType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "MktAreaInfoRprt")
public class MktAreaInfoRprt {

    @XmlElement(name = "StandardHeader", required = true)
    protected StandardHeaderType standardHeader;
    @XmlElement(name = "MktAreaList")
    protected MktAreaListType mktAreaList;
    @XmlAnyAttribute
    ...
    /**
     * Gets the value of the mktAreaList property.
     * 
     * @return
     *     possible object is
     *     {@link MktAreaListType }
     *     
     */
    public MktAreaListType getMktAreaList() {
        return mktAreaList;
    }

    /**
     * Sets the value of the mktAreaList property.
     * 
     * @param value
     *     allowed object is
     *     {@link MktAreaListType }
     *     
     */
    public void setMktAreaList(MktAreaListType value) {
        this.mktAreaList = value;
    }
