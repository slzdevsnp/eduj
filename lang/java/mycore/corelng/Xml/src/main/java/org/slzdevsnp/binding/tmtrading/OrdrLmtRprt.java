 ...
 *         &lt;element name="MbrList" type="{http://www.deutsche-boerse.com/m7/v6}MemberVolumeMbrListType"/>
...
@XmlRootElement(name = "OrdrLmtRprt")
public class OrdrLmtRprt {

    @XmlElement(name = "StandardHeader", required = true)
    protected StandardHeaderType standardHeader;
    @XmlElement(name = "MbrList", required = true)
    protected MemberVolumeMbrListType mbrList;
    @XmlAnyElement
     ...
     * @return
     *     possible object is
     *     {@link MemberVolumeMbrListType }
     *     
     */
    public MemberVolumeMbrListType getMbrList() {
        return mbrList;
    }

    /**
     * Sets the value of the mbrList property.
     * 
     * @param value
     *     allowed object is
     *     {@link MemberVolumeMbrListType }
     *     
     */
    public void setMbrList(MemberVolumeMbrListType value) {
        this.mbrList = value;
    }
