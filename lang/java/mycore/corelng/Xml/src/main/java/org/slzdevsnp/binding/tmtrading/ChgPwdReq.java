 ...
 *       &lt;/sequence>
 *       &lt;attribute name="currentPwd" use="required" type="{http://www.deutsche-boerse.com/m7/v6}stringType64" />
 *       &lt;attribute name="newPwd" use="required" type="{http://www.deutsche-boerse.com/m7/v6}stringType64" />
...
public class ChgPwdReq {
    ...
    @XmlAttribute(name = "currentPwd", required = true)
    protected String currentPwd;
    @XmlAttribute(name = "newPwd", required = true)
