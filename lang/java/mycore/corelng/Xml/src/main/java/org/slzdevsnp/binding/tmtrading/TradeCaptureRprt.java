 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Trade" type="{http://www.deutsche-boerse.com/m7/v6}TradeListEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
...
public class TradeCaptureRprt {
     ...
     * @return
     *     possible object is
     *     {@link TradeCaptureRprt.TradeList }
     *     
     */
    public TradeCaptureRprt.TradeList getTradeList() {
        return tradeList;
    }
     ...
     *     
     */
    public void setTradeList(TradeCaptureRprt.TradeList value) {
    ...
    public static class TradeList {
        ...
        protected List<TradeListEntryType> trade;
        @XmlAnyAttribute
        private Map<QName, String> otherAttributes = new HashMap<QName, String>();
         ...
         * {@link TradeListEntryType }
         * 
         * 
         */
        public List<TradeListEntryType> getTrade() {
            if (trade == null) {
                trade = new ArrayList<TradeListEntryType>();
            }
            return this.trade;
        }
