 ...
 *         &lt;element name="mbrId" type="{http://www.deutsche-boerse.com/m7/v6}stringType5" maxOccurs="1000" minOccurs="0"/>
 *       &lt;/sequence>
...
public class AllUsersReq {
     ...
     * This is why there is not a <CODE>set</CODE> method for the mbrId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMbrId().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getMbrId() {
        if (mbrId == null) {
            mbrId = new ArrayList<String>();
        }
        return this.mbrId;
    }
