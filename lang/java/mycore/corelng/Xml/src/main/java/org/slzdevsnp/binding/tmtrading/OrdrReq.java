 ...
 *       &lt;attribute name="inclPreArranged" type="{http://www.deutsche-boerse.com/m7/v6}boolType" />
...
@XmlRootElement(name = "OrdrReq")
public class OrdrReq {
    ...
    @XmlAttribute(name = "inclPreArranged")
