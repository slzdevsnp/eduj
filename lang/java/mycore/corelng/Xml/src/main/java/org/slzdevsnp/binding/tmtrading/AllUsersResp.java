 ...
 *         &lt;element name="UsrList">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Usr" type="{http://www.deutsche-boerse.com/m7/v6}FullUserType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
...
public class AllUsersResp {
    ...
    /**
     * Gets the value of the usrList property.
     * 
     * @return
     *     possible object is
     *     {@link AllUsersResp.UsrList }
     *     
     */
    public AllUsersResp.UsrList getUsrList() {
        return usrList;
    }

    /**
     * Sets the value of the usrList property.
     * 
     * @param value
     *     allowed object is
     *     {@link AllUsersResp.UsrList }
     *     
     */
    public void setUsrList(AllUsersResp.UsrList value) {
        this.usrList = value;
    }
    ...
    public static class UsrList {
        ...
        @XmlElement(name = "Usr")
        protected List<FullUserType> usr;
        @XmlAnyAttribute
        private Map<QName, String> otherAttributes = new HashMap<QName, String>();
         ...
         * 
         */
        public List<FullUserType> getUsr() {
            if (usr == null) {
                usr = new ArrayList<FullUserType>();
            }
            return this.usr;
        }
