 ...
 *       &lt;/sequence>
 *       &lt;attribute name="sobConnectionState" type="{http://www.deutsche-boerse.com/m7/v6}stringType128" />
...
@XmlRootElement(name = "HubToHubHeartbeat")
public class HubToHubHeartbeat {

    @XmlElement(name = "StandardHeader", required = true)
    protected StandardHeaderType standardHeader;
    @XmlAnyElement
    protected List<Element> any;
    @XmlAttribute(name = "sobConnectionState")
    protected String sobConnectionState;
    @XmlAnyAttribute
    ...
    /**
     * Gets the value of the sobConnectionState property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSobConnectionState() {
        return sobConnectionState;
    }

    /**
     * Sets the value of the sobConnectionState property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSobConnectionState(String value) {
        this.sobConnectionState = value;
    }
