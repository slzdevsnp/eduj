...
import packt.j9fprog.genericMethods.model.Car;
import packt.j9fprog.genericMethods.model.Skill;
...
public class FunctionalInterfaces {
    public static void main(String args[]) {
        ...
        Optional<String> ooptinal = Optional.empty();
        System.out.println(ooptinal.orElse("Missing value"));

        optional.ifPresent((s) -> System.out.println("actually present:"+s)); //Print if present
    }
}
