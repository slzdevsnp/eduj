...
public class ParallelSortStream {
    public static void main(String args[]) throws ExecutionException, InterruptedException {
        ...
        List<String> values = getReallyBigList(10000000); //1E7
        sequentialSort(values);
        parallelSort(values);
        maxParallelSort(values, 4);
    }
    ...
    private static void parallelSort(List<String> values) {
        long t0 = System.nanoTime();
        //parallelStream  provisions n-1 cores of the system for processing
    ...
    private static void sequentialSort(List<String> values) {
        ...
        System.out.println(sorted.get(10)); //sz needed to make execute the lazy sort op
        long t1 = System.nanoTime();
        long millis = TimeUnit.NANOSECONDS.toMillis(t1 - t0);
