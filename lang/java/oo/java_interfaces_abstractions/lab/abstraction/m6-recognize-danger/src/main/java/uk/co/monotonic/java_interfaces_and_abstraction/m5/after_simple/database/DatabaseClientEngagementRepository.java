package uk.co.monotonic.java_interfaces_and_abstraction.m5.after_simple.database;

import uk.co.monotonic.java_interfaces_and_abstraction.m5.after_simple.ClientEngagement;
import uk.co.monotonic.java_interfaces_and_abstraction.m5.after_simple.ClientEngagementRepository;
import uk.co.monotonic.java_interfaces_and_abstraction.m5.after_simple.Query;
import uk.co.monotonic.java_interfaces_and_abstraction.m5.after_simple.RepositoryException;
...
public class DatabaseClientEngagementRepository implements ClientEngagementRepository
{
        ...
        try
        {
            connection.createStatement().executeUpdate(
                    "CREATE TABLE IF NOT EXISTS " +
                        ...
                        "revenueReceived FLOAT NOT NULL" +
                        ")");

            addStatement = connection.prepareStatement(
                    "INSERT INTO client_engagements (client, hoursWorked, revenueReceived) VALUES (?, ?, ?)",
    ...
    public void add(final ClientEngagement clientEngagement) throws RepositoryException
    {
        try
        {
            ...
            addStatement.setDouble(3, clientEngagement.getRevenueReceived());
