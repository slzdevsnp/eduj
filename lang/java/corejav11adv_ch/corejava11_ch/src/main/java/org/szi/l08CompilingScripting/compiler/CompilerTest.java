package org.szi.l08CompilingScripting.compiler;
...
public class CompilerTest
{
   public static void main(final String[] args) throws IOException, ClassNotFoundException
   {
      ...
      String frameClassName = args.length == 0 ? "org.szi.l08CompilingScripting.buttons2.ButtonFrame" : args[0];
      ...
      throws IOException, ClassNotFoundException
   {
      ...
      props.load(Class.forName(superclassName).getResourceAsStream("/action.properties"));  //this is read from src/main/resources/
