...
public class PathDemos {
    public static void main(String[] args) {
        ...
        // Project directory
        Path project = Paths.get(".");  //get current dir
        ...
        System.out.println(String.format("project current path: {%s}",project.toAbsolutePath()));
        ...
        System.out.println("## elements of  project path");
