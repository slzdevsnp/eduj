...
public class SparkStructuredStreaming {
    ...
    private static final String CHECKPOINT_LOCATION = "/opt/sdata/spark/rsvpck";
    ...
    public static void main(String[] args) throws InterruptedException, StreamingQueryException {
        ...
        Dataset<Row> rsvpAndTimestampDF = meetupDF
                .select(col("timestamp"),
                        from_json(col("value").cast("string"), RSVP_SCHEMA).alias("rsvp"))
                .alias("meetup")
                .select("meetup.*");
        ...
        Dataset<Row> window = rsvpAndTimestampDF
                ...
                .groupBy(
                        window(col("timestamp"), "4 minutes", "1 minutes"),  // orig 4, 2
                        col("rsvp.guests"))
                .count();
        ...
        rsvpAndTimestampDF.writeStream()
                .format("console")
                .option("truncate","false")
                .start()
                .awaitTermination();

        //original query aggregated (transformed) dataset
