...
public class SparkDataset {
        ...
        //sz interval between two batches in foreachRDD loop
        private static final int BATCH_DURATION_INTERVAL_MS = 5000; //5000
        ...
        public static void main(String[] args) throws InterruptedException {
                ...
                streamingContext.start();  //multi-threaded
