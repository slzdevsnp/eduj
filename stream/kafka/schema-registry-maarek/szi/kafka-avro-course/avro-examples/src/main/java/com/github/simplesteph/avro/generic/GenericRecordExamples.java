...
public class GenericRecordExamples {
    ...
    public static void main(String[] args) {
        ...
        // step 1.0 build our first customer from data
        ...
        System.out.println("cusomerWithDefault: " + customerWithDefault);

        // we start triggering errors
        GenericRecordBuilder customerWrong = new GenericRecordBuilder(schema);
        // non existent field
        //customerWrong.set("new_field", "foobar");  //this produces runtime error
     ...
     //  customerWrong.set("first_name", "John");
        ...
        try (DataFileWriter<GenericRecord> dataFileWriter = new DataFileWriter<>(datumWriter)) {
            //this will write the file to the project working direcotry
