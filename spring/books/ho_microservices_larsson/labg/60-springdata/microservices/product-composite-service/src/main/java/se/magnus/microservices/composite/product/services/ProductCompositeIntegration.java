...
public class ProductCompositeIntegration
    ...
    //constructor with values from application.yml
    @Autowired
    ...
    public Product createProduct(Product body) {
        ...
        try {
            ...
            Product product = restTemplate.postForObject(url, body, Product.class);  //delegating
    ...
    public Product getProduct(int productId) {
        ...
        try {
            ...
            Product product = restTemplate.getForObject(url, Product.class); //delegating
