...
public class JdbcRestaurantRepository implements RestaurantRepository {
   ...
   /*
      with this approach  the default class constrictopr called   new JdbcRestaurantRepository()
      then the autowired setDataSource() method is called
      then the postConstruct  populateRestaurantCache() method is called.

      this approach allows to avoid calling in constructors  the populateCache() method
    */
