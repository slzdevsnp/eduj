...
public class RewardNetworkImpl implements RewardNetwork {
	...
	/* this sequence of related actions should be a transaction */
	//@Transactional(propagation=Propagation.REQUIRES_NEW)  //  Propagation.REQUIRES_NEW for demonstration only in RewardNetworkPropagationTests
