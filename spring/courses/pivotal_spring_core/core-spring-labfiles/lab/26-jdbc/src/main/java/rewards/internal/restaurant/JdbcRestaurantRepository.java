...
public class JdbcRestaurantRepository implements RestaurantRepository {
	...
	private RowMapper<Restaurant> restaurantRowMapper = new RestaurantRowMapper();
	...
	public Restaurant findByMerchantNumber(String merchantNumber) {
		...
		Restaurant restaurant = jdbcTemplate.queryForObject(sql, restaurantRowMapper, merchantNumber);
		return restaurant;
	}
